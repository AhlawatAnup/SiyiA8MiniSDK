...
Siyi_camera.prototype.decode_request_firmware_version=function (buffer) {
    this.emit("request_firmware_version",{ code_board_ver: buffer.readUInt32LE(0),
...
Siyi_camera.prototype.decode_request_hardware_id=function (buffer) {
    this.emit("request_hardware_id",{ hardware_id: buffer.toString("ascii", 0, 12)});
    }
...
Siyi_camera.prototype.decode_manual_zoom_auto_focus=function (buffer) {
    this.emit("manual_zoom_auto_focus",{ zoom_multiple: buffer.readUInt16LE(0)});
    }
...
Siyi_camera.prototype.decode_absolute_zoom_auto_focus=function (buffer) {
    this.emit("absolute_zoom_auto_focus",{ absolute_movement_ask: buffer.readUInt8(0)});
    }
...
Siyi_camera.prototype.decode_request_max_zoom_value=function (buffer) {
    this.emit("request_max_zoom_value",{ zoom_max_int: buffer.readUInt8(0),
...
Siyi_camera.prototype.decode_request_current_zoom_value=function (buffer) {
    this.emit("request_current_zoom_value",{ zoom_max_int: buffer.readUInt8(0),
    zoom_max_float: buffer.readUInt8(1)});
    }
...
Siyi_camera.prototype.decode_request_gimbal_config=function (buffer) {
    this.emit("request_gimbal_config",{ reserved: buffer.readUInt8(0),
...
Siyi_camera.prototype.decode_request_camera_codec=function (buffer) {
    this.emit("request_camera_codec",{ stream_type: buffer.readUInt8(0),
...
Siyi_camera.prototype.decode_request_min_max_image_temperature=function (buffer) {
    this.emit("request_min_max_image_temperature",{ temp_max: buffer.readUInt16LE(0),
    temp_min: buffer.readUInt16LE(2),
    temp_max_x: buffer.readUInt16LE(4),
    temp_max_y: buffer.readUInt16LE(6),
    temp_min_x: buffer.readUInt16LE(8),
    temp_min_y: buffer.readUInt16LE(10)});
    }
